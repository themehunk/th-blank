 ...
 */
if ( ! function_exists( 'th_blank_admin_scripts' ) ) :
    /**
     * Enqueue scripts for admin page only: Theme info page
     */
    function th_blank_admin_scripts( $hook ){
...
add_action( 'admin_enqueue_scripts', 'th_blank_admin_scripts' );
...
$meta_boxes = array(
      array(
        'id' => 'open-meta-box',
        'title' => esc_html__('Dynamic Sidebar','th-blank'),
        'pages' => array('page','post','product'),// custom post type array('page','post', 'link')
        'context' => 'side',
        'priority' => 'low',
        'fields' => array(
            array(
                'name' => esc_html__('Sidebar','th-blank'),
                'id' => $prefix . 'sidebar_dyn',
                'type' => 'select',
                'std' => 'right',
                'options' => array( 
                    array("value" => 'right',"name" => esc_html__('Right Sidebar','th-blank')),
                    array("value" => 'no-sidebar',"name" => esc_html__('No Sidebar','th-blank')),
                    array("value" => 'left',"name" =>  esc_html__('Left Sidebar','th-blank')),
...
foreach ($meta_boxes as $meta_box){
    $my_box = new th_blank_thMetaDataClass($meta_box);
}

class th_blank_thMetaDataClass {
