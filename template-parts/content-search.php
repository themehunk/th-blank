					...
					<div class="thunk-posts-description ">
						...
						<div class="thunk-post-comments">
							<div class="thunk-comments-icon">
								<span class="thunk-comments"><a href="<?php comments_link(); ?>" title=""><?php comments_popup_link(esc_html('0','th-blank'), esc_html('1','th-blank'), esc_html('%','th-blank')); ?></a></span>
							</div>
						</div>
					    </div>
						<div class="thunk-post-excerpt">
								<?php th_blank_the_excerpt('excerpt');?> 
						</div>
